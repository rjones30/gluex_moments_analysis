...
// Mon Jun 19 15:37:40 2023 by ROOT version 6.08/06
// from TTree etapi0_moments/etapi0_moments
// found on file: etapi0_moments_x10_0.root
//////////////////////////////////////////////////////////

#ifndef moments_plotter_h
#define moments_plotter_h
...
class moments_plotter : public TSelector {
public :
   TTreeReader     fReader;  //!the tree reader
   TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain

   TProfile *hmoment[3][49];
   double massEtaPi0;
   double massEtaPi0_;
   double abst;
   double abst_;
   ...
   TTreeReaderValue<Double_t> massEtaPi0_ = {fReader, "massEtaPi0_"};
   ...
   TTreeReaderValue<Double_t> massEtaPi0 = {fReader, "massEtaPi0"};
   ...
   TTreeReaderArray<Double_t> model1moment = {fReader, "model1moment"};
   TTreeReaderArray<Double_t> model1moment_ = {fReader, "model1moment_"};
#endif


   moments_plotter(TTree * /*tree*/ =0) { }
   virtual ~moments_plotter() { }
   ...
   ClassDef(moments_plotter,0);

};

#endif

#ifdef moments_plotter_cxx
void moments_plotter::Init(TTree *tree)
{
...
#endif // #ifdef moments_plotter_cxx
