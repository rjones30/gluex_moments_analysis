...
class DSelector_etapi0_moments : public DSelector
{
	...
	private:
		...
		double YmomGJ[49]; // L=0...6
		double YmomEta[28]; // L=0,2,4,6
		double YmomPi0[28]; // L=0,2,4,6
		double YmomGJ_[49]; // L=0...6
		double YmomEta_[28]; // L=0,2,4,6
		double YmomPi0_[28]; // L=0,2,4,6
